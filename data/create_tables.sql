...
-- created_at : Date où l'on insère un enregistrement dans la base
...
CREATE TABLE "question" (
  ...
  "good_answer_id" integer NOT NULL REFERENCES "answer"("id"), -- 'La BONNE réponse du quiz',
